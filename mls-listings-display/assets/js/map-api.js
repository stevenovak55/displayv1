...
const MLD_API = {
    ...
    fetchDynamicFilterOptions: function() {
        const contextFilters = MLD_Filters.getCombinedFilters(MLD_Filters.getModalState(true), ['home_type', 'status', 'structure_type', 'architectural_style', 'SpaYN', 'WaterfrontYN', 'ViewYN', 'MLSPIN_WATERVIEW_FLAG', 'PropertyAttachedYN', 'MLSPIN_LENDER_OWNED']);
        ...
        .done(function(response) {
            if (response.success && response.data) {
                ...
                MLD_Filters.populateAmenityCheckboxes(response.data);
            }
        })
        .fail(function() {
